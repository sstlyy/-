	...
	<div>
		...
		<div class="container cart" align="center"
			...
			<div style="margin-top: 60px; padding-top: 90px;">
				<h3>
					<img src="image/fail.png" width="48" height="48"> 支付失败，请稍后再试
					
				</h3>
				<br> <font style="font-size: 16px">失败原因：<span
						style="color: red">${payStatus.msg}</span></font> <br> <br>
			</div>
			<div
				style="margin-top: 170px; margin-left: 600px; border: 1px solid rgb(205, 205, 205); width: 160px; height: 35px; line-height: 30px;">
				<a
					href="${pageContext.request.contextPath }/order_andPayOrder.action"><font
					style="font-size: 18px; color: rgb(36, 160, 215)">返回支付页面</font></a>
			</div>
